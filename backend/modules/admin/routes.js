...
const enquiryPlansRoutes        = require("./enquiryPlansManagement/routes");
const leadEnquiryCoinsConfigRoutes = require("./leadEnquiryCoinsConfig/routes");
...
router.use("/enquiry-plans",              enquiryPlansRoutes);
router.use("/lead-enquiry-coins-config", leadEnquiryCoinsConfigRoutes);
